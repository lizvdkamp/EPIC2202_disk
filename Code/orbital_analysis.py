...
def plot_parameter(P, m2, parameter, parameter_name, lvls=10, xlim=None, 
    ...
    # plot image
    im = ax.imshow(plot_parameter.value, extent=ext, origin='lower',
    ...
    plt.ylabel(r'Mass [$M_{Jup}$]', fontsize=20)
    ...
    cbar = fig.colorbar(im, ticks=ticks, cax=cax, orientation='vertical', format='%.2f')
